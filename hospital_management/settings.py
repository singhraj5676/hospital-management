...
SECRET_KEY = 'django-insecure-q041@!24$c&f8avv1u-_hg!alge+#5=q_p164-(-ez*l)#tx5r'
...
AUTHENTICATION_BACKENDS = [
    'django.contrib.auth.backends.ModelBackend',  # Default Django backend for normal auth
